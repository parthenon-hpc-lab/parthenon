...
.. code:: c++
   ...
   parthenon::TaskStatus my_task(MeshData *md) {
     ...
     parthenon::par_for(/*index ranges, etc. go here */,
       ...
       pack(b, var1_t(), k, j, i) = 2.0 * pack(b, var2_t(), k, j, i);
...
.. code:: c++
   ...
   parthenon::TaskStatus my_task(MeshData *md) {
     ...
     parthenon::par_for(/*index ranges, etc. go here */,
         ...
         if (pack.GetSize(b, sparse_var_t()) > 0) {
