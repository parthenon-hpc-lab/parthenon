...
|| PARTHENON\_ENABLE\_RAW\_OPENMP           || OFF                           || Option || Enable OpenMP parallelism in the raw host-loop abstraction backend, independently of the Kokkos execution spaces                                                       |
