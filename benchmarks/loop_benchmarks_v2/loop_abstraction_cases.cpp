...
PLB2_INSTANTIATE_ABSTRACTION_STENCILS(bovi, logical_coords);
PLB2_INSTANTIATE_ABSTRACTION_STENCILS(boiv, logical_coords);
PLB2_INSTANTIATE_ABSTRACTION_STENCILS(bvoi, memory);
PLB2_INSTANTIATE_ABSTRACTION_STENCILS(bvoi, logical_flat);
