...
##############################################################################
# Adapted from: https://github.com/Alpine-DAV/ascent/blob/2228b2827dd99790c2fe4bc5b05f5b9c7ea42e71/scripts/build_ascent/build_ascent.sh
# Original Copyright (c) 2015-2024, Lawrence Livermore National Security, LLC.
...
if [ ! -d ${ascent_src_dir} ]; then
    echo "**** Cloning Ascent"
    git clone --recursive https://github.com/Alpine-DAV/ascent.git $(ospath ${source_dir}/ascent)
fi
