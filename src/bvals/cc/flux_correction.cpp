      ...
      KOKKOS_LAMBDA(parthenon::team_mbr_t team_member) {
        ...
        Kokkos::parallel_for(
            Kokkos::TeamThreadRange<>(team_member, NtNuNvNkNjNi), [&](const int idx) {
              ...
              // in the average
              const Real area00 = coords.da(binfo.dir, k, j, i);
              const Real area01 = coords.da(binfo.dir, k, j + joff, i + ioff);
              const Real area10 = coords.da(binfo.dir, k + koff, j + joff, i);
              const Real area11 = coords.da(binfo.dir, k + koff, j, i + ioff);
