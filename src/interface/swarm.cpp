...
SwarmDeviceContext Swarm::GetDeviceContext() const {
  ...
  context.jb_s_ = jb.s;
  context.kb_s_ = kb.s;
  context.x_min_ = pmb->coords.Xf<1, 1>(ib.s);
  context.y_min_ = pmb->coords.Xf<2, 2>(jb.s);
  context.z_min_ = pmb->coords.Xf<3, 3>(kb.s);
  context.x_max_ = pmb->coords.Xf<1, 1>(ib.e + 1);
  context.y_max_ = pmb->coords.Xf<2, 2>(jb.e + 1);
  context.z_max_ = pmb->coords.Xf<3, 3>(kb.e + 1);
