...
void MeshRefinement::RestrictCellCenteredValues(const ParArrayND<Real> &fine,
  ...
  if (pmb->block_size.nx3 > 1) { // 3D
    ...
    pmb->par_for("RestrictCellCenteredValues1d", sn, en, csi, cei,
...
void MeshRefinement::ProlongateCellCenteredValues(const ParArrayND<Real> &coarse,
  ...
  if (pmb->block_size.nx3 > 1) {
    ...
    int k = ckb.s, fk = kb.s;
    pmb->par_for("ProlongateCellCenteredValues2d", sn, en, sj, ej, si, ei,
    ...
    pmb->par_for("ProlongateCellCenteredValues1d", sn, en, si, ei,
