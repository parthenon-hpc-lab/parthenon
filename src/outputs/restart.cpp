...
void RestartOutput::WriteOutputFile(Mesh *pm, ParameterInput *pin, SimTime *tm) {
...

  {
    ...
    // first we need to get list of variables, because sparse variables are only expanded on some
    // blocks, we need to look at the list of variables on each block
