...
class ParArrayGeneric {
 public:
  ...
  template<class... Ts> 
  operator ParArrayGeneric<Kokkos::View<Ts...>>() const { return ParArrayGeneric<Kokkos::View<Ts...>>(data_); }
...
template<class T, class U>
inline void deep_copy(const parthenon::ParArrayGeneric<T>& dest, const parthenon::ParArrayGeneric<U>& src) { 
