...
void Reconstruction::PiecewiseParabolicX1(const int k, const int j, const int il,
  ...
  ParArrayND<Real> &q_im2 = scr2_ni_, &q_im1 = scr3_ni_, &q_i = scr4_ni_,
                   &q_ip1 = scr5_ni_, &q_ip2 = scr6_ni_, &qr_imh = scr7_ni_,
                   &ql_iph = scr8_ni_;
...
void Reconstruction::PiecewiseParabolicX2(const int k, const int j, const int il,
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  ParArrayND<Real> &q_jm2 = scr2_ni_, &q_jm1 = scr3_ni_, &q_j = scr4_ni_,
                   &q_jp1 = scr5_ni_, &q_jp2 = scr6_ni_, &qr_jmh = scr7_ni_,
                   &ql_jph = scr8_ni_;
...
void Reconstruction::PiecewiseParabolicX3(const int k, const int j, const int il,
  ...
  // set work arrays used for primitive/characterstic cell-averages to scratch
  ParArrayND<Real> &q_km2 = scr2_ni_, &q_km1 = scr3_ni_, &q_k = scr4_ni_,
                   &q_kp1 = scr5_ni_, &q_kp2 = scr6_ni_, &qr_kmh = scr7_ni_,
                   &ql_kph = scr8_ni_;
  ...
  ParArrayND<Real> &d2qc_km1 = scr07_i_, &d2qc = scr08_i_, &d2qc_kp1 = scr09_i_,
                   &d2qf = scr10_i_;
