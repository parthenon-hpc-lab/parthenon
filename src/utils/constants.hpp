...
template <typename UNITSYSTEM> class PhysicalConstants {
  ...
  public:
    ...
    static constexpr double GravitationalConstant = 6.67384e-11 * Length
    ...
    static constexpr double AccelerationFromGravity = 9.80665 * Length
      / (Time * Time);
    ...
    static constexpr double StefanBoltzmann = 2.0 * M_PI * M_PI * M_PI * M_PI
      * M_PI * kb * kb * kb * kb / (15.0 * h * h * h * c * c);
    ...
    static constexpr double PermeabilityOfVacuum = 4.0 * M_PI * 1.0e-7 * Force
      / (Current * Current);
...
template<typename T> constexpr double PhysicalConstants<T>::Avogadro;
template<typename T> constexpr double PhysicalConstants<T>::Na;
template<typename T> constexpr double PhysicalConstants<T>::FineStructure;
template<typename T> constexpr double PhysicalConstants<T>::alpha;
template<typename T> constexpr double PhysicalConstants<T>::Planck;
template<typename T> constexpr double PhysicalConstants<T>::h;
template<typename T> constexpr double PhysicalConstants<T>::ReducedPlanck;
template<typename T> constexpr double PhysicalConstants<T>::hbar;
template<typename T> constexpr double PhysicalConstants<T>::GasConstant;
template<typename T> constexpr double PhysicalConstants<T>::R;
template<typename T> constexpr double PhysicalConstants<T>::Boltzmann;
template<typename T> constexpr double PhysicalConstants<T>::kb;
template<typename T> constexpr double PhysicalConstants<T>::ElectronCharge;
template<typename T> constexpr double PhysicalConstants<T>::qe;
template<typename T> constexpr double PhysicalConstants<T>::SpeedOfLight;
template<typename T> constexpr double PhysicalConstants<T>::c;
template<typename T> constexpr double PhysicalConstants<T>::GravitationalConstant;
template<typename T> constexpr double PhysicalConstants<T>::G;
template<typename T> constexpr double PhysicalConstants<T>::AccelerationFromGravity;
template<typename T> constexpr double PhysicalConstants<T>::g;
template<typename T> constexpr double PhysicalConstants<T>::ElectronMass;
template<typename T> constexpr double PhysicalConstants<T>::me;
template<typename T> constexpr double PhysicalConstants<T>::ProtonMass;
template<typename T> constexpr double PhysicalConstants<T>::mp;
template<typename T> constexpr double PhysicalConstants<T>::StefanBoltzmann;
template<typename T> constexpr double PhysicalConstants<T>::sb;
template<typename T> constexpr double PhysicalConstants<T>::FaradayConstant;
template<typename T> constexpr double PhysicalConstants<T>::F;
template<typename T> constexpr double PhysicalConstants<T>::PermeabilityOfVacuum;
template<typename T> constexpr double PhysicalConstants<T>::mu0;
template<typename T> constexpr double PhysicalConstants<T>::PermittivityOfVacuum;
template<typename T> constexpr double PhysicalConstants<T>::eps0;
template<typename T> constexpr double PhysicalConstants<T>::ClassicalElectronRadius;
template<typename T> constexpr double PhysicalConstants<T>::re;
template<typename T> constexpr double PhysicalConstants<T>::ElectronVolt;
template<typename T> constexpr double PhysicalConstants<T>::eV;
template<typename T> constexpr double PhysicalConstants<T>::AtomicMassUnit;
template<typename T> constexpr double PhysicalConstants<T>::amu;
