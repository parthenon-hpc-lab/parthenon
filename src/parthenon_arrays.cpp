...
PARTHENON_ARRAY_SPEC(int32_t);
PARTHENON_ARRAY_SPEC(int64_t);
PARTHENON_ARRAY_SPEC(uint32_t);
PARTHENON_ARRAY_SPEC(uint64_t);
...
PARTHENON_VIEW_TYPE_INSTANTIATION(int32_t);
PARTHENON_VIEW_TYPE_INSTANTIATION(int64_t);
PARTHENON_VIEW_TYPE_INSTANTIATION(uint32_t);
PARTHENON_VIEW_TYPE_INSTANTIATION(uint64_t);
