...
class SparseAdvectionDriver : public MultiStageDriver {
 public:
  SparseAdvectionDriver(ParameterInput *pin, ApplicationInput *app_in, Mesh *pm);
  ...
  //         SparseAdvectionDriver::MakeTaskCollection (advection_driver.cpp)
  TaskCollection MakeTaskCollection(BlockList_t &blocks, int stage);
};

void ProblemGenerator(MeshBlock *pmb, parthenon::ParameterInput *pin);
void PostStepDiagnosticsInLoop(Mesh *mesh, parthenon::ParameterInput *pin,
